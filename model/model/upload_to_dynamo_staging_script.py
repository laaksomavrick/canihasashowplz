...
def start():
    print(
        "Importing staging data into staging tables - make sure your shell has AWS_PROFILE set!"
    )
    dynamodb = resource("dynamodb")
    shows_table = dynamodb.Table("canihaveatvshowplz-staging-ShowsV1")
    ratings_table = dynamodb.Table("canihaveatvshowplz-staging-RatingsV1")
